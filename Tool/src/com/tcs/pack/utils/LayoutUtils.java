...
import com.tcs.pack.search.ui.ButtonControlPanel;
...
public class LayoutUtils {
	...
	public static GridBagConstraints getDefaultGridBagConstraints(final int x, final int y, final double weightX, final double weightY) {
		final GridBagConstraints gc = getDefaultGridBagConstraints(x, y);
		gc.weightx = weightX;
		gc.weighty = weightY;
		return gc;
	...
	public static ControlPanel arrangeComponantsInColoumn(final String title, final boolean expand, final Component... components) {
		final ControlPanel panel = arrangeComponantsInColoumn(null, expand, GridBagConstraints.BOTH, components);
		panel.setBorder(BorderFactory.createTitledBorder(title));
		return panel;
	}
	public static ControlPanel arrangeComponantsInColoumn(final String title,int fillType, final boolean expand, final Component... components) {
	...
	public static ControlPanel arrangeComponantsInColoumn(final boolean expand, final int fillType, final Component... components) {
	...
	public static ControlPanel arrangeComponantsInRow(final String panelTitle, final boolean expand, final Component... components) {
	...
	public static ControlPanel arrangeComponantsInRow(final String panelTitle,final int fillType, final boolean expand, final Component... components) {
	 ...
	 * @return
	 */
	private static GridBagConstraints getCaluculatedGC(GridBagConstraints gc, final boolean expand, final LayoutUtils utils, final Component comp) {
