...
public class Action implements Runnable {
    ...
    public Object configure(Object object,  String methodName, Object... parameters)
...
//        System.out.println("getAvailableMethods:"+methodName);
    ...
    public static void main(String args[]){
       ...
       /* String str = new String("This is String");
        try {
            Object obj =action.configure(str,str.getClass(),"split"," ");
        ...
        } catch (IllegalAccessException | IllegalArgumentException | InvocationTargetException | NoSuchObjectException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }*/
        MockableClass mock = new MockableClass();
        try {
            Object obj =action.configure(mock, "getClass", null);
            System.out.println(obj);
        } catch (NoSuchObjectException | IllegalAccessException | IllegalArgumentException | InvocationTargetException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    }
