...
public class PluginNameTagHandler extends DefaultTaghandler {
    /*
     * (non-Javadoc)
     * 
    ...
    public void characters(char[] ch, int start, int length) throws SAXException {
        if (dependency.getPluginName() != null) {
            dependency.setPluginName(dependency.getPluginName() + String.valueOf(ch, start, length));
        } else {
            dependency.setPluginName(String.valueOf(ch, start, length));
        }
    }
}
