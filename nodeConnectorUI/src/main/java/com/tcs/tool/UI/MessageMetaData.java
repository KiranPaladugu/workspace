...
public class MessageMetaData implements Cloneable, Serializable {
	...
	public synchronized void setMessageName(final String messageName) {
	...
	public synchronized void setMessageId(final String messageId) {
	...
	public void setAutoSend(final boolean isAutoSend) {
	...
	public void setEnableSend(final boolean enableSend) {
