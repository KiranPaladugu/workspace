...
public class UISavableMessage<T> extends Message<T> implements Serializable {
	...
	public synchronized void setAutoSend(final boolean autoSend) {
	...
	public synchronized void setFirst(final boolean isFirst) {
	...
	public boolean equals(final Object obj) {
		...
		final UISavableMessage<?> other = (UISavableMessage<?>) obj;
		if (autoSend != other.autoSend) return false;
