...
public abstract class Message<T> implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (endOfMessageDelim == null) {
			if (other.endOfMessageDelim != null) return false;
		} else if (!endOfMessageDelim.equals(other.endOfMessageDelim)) return false;
		if (id == null) {
		...
		if (replyExpected != other.replyExpected) return false;
		return true;
	}
	...
	public String toString() {
		return "Message [messageType=" + messageType + ", message=" + message + ", replyExpected=" + replyExpected + ", endOfMessageDelim="
				+ endOfMessageDelim + ", name=" + name + ", id=" + id + "]";
	}
