    ...
    public static void main(String[] arg) {
        ...
        try {
            ...
            if (arg.length > 0) {
                ...
                host = JOptionPane.showInputDialog("Enter username@hostname", "test" + "@10.170.117.194");
            }
            ...
            System.out.println(session.getHostKeyRepository().getKnownHostsRepositoryID());
            ...
            /*
             * // a hack for MS-DOS prompt on Windows. channel.setInputStream(new FilterInputStream(System.in){ public int
             * read(byte[] b, int off, int len)throws IOException{ return in.read(b, off, (len>1024?1024:len)); } });
             */
